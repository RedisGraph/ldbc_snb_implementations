...
import com.ldbc.impls.workloads.ldbc.snb.redisgraph.converter.RedisGraphCypherConverter;

import java.util.Calendar;
import java.util.Date;

public class RedisGraphCypherQueryStore extends QueryStore {

    public RedisGraphCypherQueryStore(String path) throws DbException {
        super(path, ".cypher");
    }

    public RedisGraphCypherConverter getConverter() {
        return new RedisGraphCypherConverter();
    }
    ...
    public String getQuery3(LdbcQuery3 operation) {
        // We can't use the DB's datetime lib, because currently the dates are stored as longs, see RedisGraphCypherConverter
